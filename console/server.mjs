...
const STACK_ITEMS = [
  ...
  {
    label: "Firestore", detail: "Replay defence", tint: "251,188,4",
    icon: '<path d="M5 8.5 12 4l7 4.5-7 3.2-7-3.2z" fill="#FBBC04" stroke="none"/><path d="M5 13 12 9.4l7 3.6-7 3.2-7-3.2z" fill="#FBBC04" stroke="none" opacity=".55"/><path d="M5 17.4 12 14l7 3.4L12 20.6z" fill="#FBBC04" stroke="none" opacity=".3"/>',
  },
  {
    label: "Cloud KMS", detail: "Receipt signing", tint: "234,67,53",
    icon: '<circle cx="9.5" cy="9.5" r="4.2" fill="none" stroke="#EA4335" stroke-width="1.8"/><path d="M12.6 12.6 20 20M17 17l-2 2M19 15l-2 2" stroke="#EA4335" stroke-width="1.8"/>',
  },
  {
    label: "Cloud Audit Logs", detail: "Independent proof", tint: "154,160,166",
    icon: '<path d="M7 4h7l4 4v12H7z" fill="none" stroke="#9AA0A6" stroke-width="1.7"/><path d="M14 4v4h4" stroke="#9AA0A6" stroke-width="1.7"/><path d="M10 13h6M10 16.5h4" stroke="#9AA0A6" stroke-width="1.7"/>',
  },
];
...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    body { margin:0; background:radial-gradient(ellipse 70% 50% at 72% -4%,#123a30 0,transparent 60%),#080f0d; color:var(--paper); font:15px/1.55 ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif; }
    ...
    h1 { font-size:clamp(1.5rem,1rem + 1.5vw,2.15rem); line-height:1.22; letter-spacing:-.015em; font-weight:700; max-width:640px; margin:14px 0 18px; text-wrap:balance; }
    .summary { max-width:620px; color:#b3c6c0; font-size:.97rem; line-height:1.65; }
    ...
    .stack { display:grid; grid-template-columns:repeat(4,1fr); gap:1px; background:var(--line); border:1px solid var(--line); margin-bottom:32px; }
